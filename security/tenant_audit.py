...
class TenantAuditBoundary:
    """Require explicit trusted tenant scope for audit persistence and reads.

    Authentication and tenant resolution remain outside this boundary. Production
    callers must obtain tenant identity from the trusted deployment identity layer.
    """
...
class InMemoryTenantAuditSink:
    """Deterministic test/demo sink; not a production persistence provider."""
