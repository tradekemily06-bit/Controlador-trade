...
def test_authority_requires_terminal_broker_observation():
    ...
    assert authority.verify(request_id="req", evidence_id="ext", evidence_source="broker", broker_id="broker", symbol="BTCUSD", executed=True)
...
def test_authority_rejects_mismatched_broker_observation():
    ...
    assert not authority.verify(request_id="req", evidence_id="ext", evidence_source="broker", broker_id="broker", symbol="BTCUSD", executed=True)
