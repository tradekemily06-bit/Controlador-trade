...
class EcosystemOnboarding:
    ...
    def build_first_use_guide(self) -> OnboardingGuide:
        steps = (
            ...
            OnboardingStep("recovery", "Recuperação", "Entender como o ecossistema reage a problemas: tenta somente correções previamente classificadas como seguras, explica o que conseguiu corrigir e revalida tudo antes de permitir qualquer retomada.", OnboardingSection.RECOVERY, "Se algo bloquear a operação, abra esta parte para ver o motivo, o que foi tentado e o que você precisa fazer, sem contornar a proteção."),
        ...
        return OnboardingGuide(
            ...
            steps=steps,
            completion_message="Você já sabe onde encontrar as funções principais. O ensino contextual e o guia de recuperação continuam disponíveis quando precisar.",
