...
def test_p111_p116_p117_p119_positive_flow(tmp_path: Path):
    ...
    gateway = RealExecutionGateway(BrokerAdapterGateway(registry), ledger, ExecutionLifecycleStore(tmp_path / "lifecycle.json", ExecutionLifecycleStore(tmp_path / "lifecycle.json")))
