...
def test_ic_markets_demo_gateway_is_composed_without_connecting(tmp_path):
    ...
    gateway = build_ic_markets_mt5_demo_gateway(mt5_module=UnusedMT5(), symbol="EURUSD", state_dir=tmp_path)
...
def test_ic_markets_demo_gateway_keeps_real_blocked_before_adapter_access(tmp_path):
    ...
    gateway = build_ic_markets_mt5_demo_gateway(mt5_module=UnusedMT5(), state_dir=tmp_path)
